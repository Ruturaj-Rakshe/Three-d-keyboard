...
const Scene = () => {
    ...
    useGSAP(() => {
        ...
        tl.to(keyboard.position, {
            ...
            scrollTimeline.to(keyboard.position, {
                ...
                y: 5,
                z: 5,
                duration: 3, //flip and land effect started happening faster than before
            }, "0") //Why 0
    ...
    return (
        <group>
            ...
            <spotLight position={[-2, 1.5, 3]} intensity={10 * lightIntensityScaler} castShadow shadow-bias={-0.0002} shadow-normalBias={0.002} shadow-mapSize={1024}/>
        </group>
    )
}
